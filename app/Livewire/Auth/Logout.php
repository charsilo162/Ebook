...
class Logout extends Component
{
    ...
    public function render()
    {
        ...
        return <<<'HTML'
            <button wire:click="logout" class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-200 w-full text-left text-white hover:bg-white dark:hover:bg-red-900/10 group">
