            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex-shrink-0 flex items-center">
                    <a href="/" class="text-white font-black text-2xl tracking-tighter flex items-center gap-2">
                        ...
                        <span>Essencial<span class="opacity-70"> MARKET</span></span>
                    </a>
                </div>

                <div class="flex items-center space-x-4">
                    <a href="{{ route("home") }}" class="text-purple-100 hover:text-white text-sm font-semibold transition">Home</a>
                    <div class="h-4 w-px bg-purple-400/50"></div>
                    <a href="{{ route('contact') }}" class="text-purple-100 hover:text-white text-sm font-semibold transition">Contact Us</a>
                </div>
            </div>
        </div>
    </nav>
